...
dateBackground = "#B3D4D8";         // Background colour of full date cells
dateBackgroundH = "#FFFFCC";        // Background colour of full date cells on Mouseover
...
weekendBackground = "#A2C0C3";      // Background colour of full date cells
...
offBackground = "#E2F3FB";          // Background colour of full date cells
...
dateFormat = "DD-MM-YYYY";       // Format date will appear in text box. (MUST BE IN UPPERCASE) 
                                    // DD = date 
...
item++;
  ...
  if(dateBox==1){setCal+='<input type="text" id="calendarDate'+item+'" name="calendarDate'+item+'" value="'+def+'">';}else{setCal+='&nbsp;';}
  if(popStatus>0){
    setCal+='&nbsp;<a href="javascript:void(0)" onClick="showCalendar(\'\','+item+')"><img src="calendar.gif" border="0"  alt="Calendar Popup" /><\/a>';
  }
