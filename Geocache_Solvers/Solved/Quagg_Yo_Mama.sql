...
dbms_output.put_line( to_char(sysdate, 'HH24:MI:SS') || ' : GO');
   ...
   QUAGMIRE_SETUP.Assign_Word(4,  'THROUGH');
   QUAGMIRE_SETUP.Assign_Word(5,  'THE');
   QUAGMIRE_SETUP.Assign_Word(6,  'GAP');
   QUAGMIRE_SETUP.Assign_Word(7,  'IN');
   QUAGMIRE_SETUP.Assign_Word(8,  'THE');
   QUAGMIRE_SETUP.Assign_Word(9,  'GREEN');
   QUAGMIRE_SETUP.Assign_Word(10, 'RAILINGS');
   QUAGMIRE_SETUP.Assign_Word(11, 'AT');
   QUAGMIRE_SETUP.Assign_Word(12, 'THE');
   QUAGMIRE_SETUP.Assign_Word(13, 'GIVEN');
   QUAGMIRE_SETUP.Assign_Word(14, 'COORDINATES');
   QUAGMIRE_SETUP.Assign_Word(15, 'AND');
   QUAGMIRE_SETUP.Assign_Word(16, 'FOLLOW');
   QUAGMIRE_SETUP.Assign_Word(17, 'THE');
   QUAGMIRE_SETUP.Assign_Word(18, 'RIVER');
   QUAGMIRE_SETUP.Assign_Word(19, 'DOWNSTREAM');
   QUAGMIRE_SETUP.Assign_Word(20, 'UNTIL');
