...
WHERE  Column_Name IN ('N3', 'N17')
ORDER BY Length(Table_Name)
/
SELECT 'CREATE OR REPLACE VIEW V_' || Table_Name || ' AS (SELECT * FROM ' || replace(Table_Name, 'MAGNETISM_', 'MAGNETISM_ORIG_') || ');'
FROM   USER_TABLES
WHERE  Table_Name LIKE 'MAGNETISM_ORIG_%'
...
CREATE TABLE MAGNETISM_STOP AS (SELECT  sysdate Stop_Date FROM DUAL);
...
-- 0	0	132940	2998399	2724481	1209837	5178764	9591290	0	0
-- 0	0	132940	2998399	2349525	1757286	3042329	1026549	0	0
